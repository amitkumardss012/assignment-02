    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6 animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex gap-4 mt-8">
          ...
          <Button className="px-8 shadow-lg shadow-primary/20 gap-2 h-12 rounded-xl bg-primary hover:bg-primary/90">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-muted/20 p-6 rounded-2xl border border-dashed shadow-sm">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold tracking-tight">Quick Invoice</h3>
          </div>
          <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Session ID: {watch("invoiceNumber")}</p>
        </div>
